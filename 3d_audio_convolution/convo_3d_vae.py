...
class Convo3DVAE(nn.Module):
    def __init__(self, input_dimension, num_frames=12, hidden_dimensions1=8400, hidden_dimensions2=5400, hidden_dimensions3=3440, latent_space_dimensions=2800):
        ...
        self.conv_height = conv3d_output_size(conv3d_output_size(input_dimension, conv1_params[0], conv1_params[1], conv1_params[2]), conv2_params[0], conv2_params[1], conv2_params[2])
        self.conv_width = self.conv_height  # Assuming square frames
        self.conv_depth = conv3d_output_size(conv3d_output_size(self.num_frames, conv1_params[0], conv1_params[1], conv1_params[2]), conv2_params[0], conv2_params[1], conv2_params[2])
        ...
        self.deconvolutional_layer1 = nn.ConvTranspose3d(in_channels=out_channels, out_channels=middle_channels, kernel_size=conv2_params[0], stride=conv2_params[1], padding=conv2_params[2])
